/*
 * reverse-icmp-shell: core
 *
 * Original code from Peter Kieltyka (elux)
 *
...
int
ish_recv(int sockfd, char *recv_buf, struct sockaddr *sin, socklen_t sinlen) {
